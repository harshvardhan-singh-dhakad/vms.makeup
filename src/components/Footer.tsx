    ...
    <footer id="contact" className="bg-brand-primary text-brand-bg-primary pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 pb-12 border-b border-brand-bg-secondary/15">
          ...
          <div className="md:col-span-4 flex flex-col space-y-4 text-left">
            <div className="flex items-center space-x-2">
              ...
              <div className="ml-2">
                ...
                <span className="block text-[8px] uppercase tracking-widest text-brand-purple font-bold">
            ...
            <div className="pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center space-x-2 bg-brand-purple text-brand-primary px-5 py-2.5 rounded-xl font-sans text-xs font-bold shadow-md hover:bg-brand-purple/90 transition-all"
              >
          ...
          <div className="md:col-span-4 flex flex-col space-y-4 text-left">
            <h3 className="font-serif text-base font-bold text-brand-purple uppercase tracking-wider">
              Business Hours
            </h3>
            <div className="space-y-3 font-sans text-xs">
              <div className="flex items-start space-x-2.5">
                <Clock className="h-4.5 w-4.5 text-brand-purple mt-0.5 shrink-0" />
                <div>
              ...
              <p className="text-[10px] text-brand-purple font-medium italic">
          ...
          <div className="md:col-span-4 flex flex-col space-y-4 text-left">
            ...
            <div className="space-y-3 font-sans text-xs">
              <div className="flex items-start space-x-2.5">
                <MapPin className="h-4.5 w-4.5 text-brand-purple mt-0.5 shrink-0" />
              ...
              {SALON_INFO.contactNumber && (
                <div className="flex items-start space-x-2.5">
                  <Phone className="h-4.5 w-4.5 text-brand-purple mt-0.5 shrink-0" />
                  <a href={`tel:${SALON_INFO.contactNumber}`} className="hover:underline hover:text-brand-purple">
                    {SALON_INFO.contactNumber}
                  </a>
                </div>
              )}
            ...
            <div className="bg-brand-bg-secondary/10 border border-brand-bg-secondary/20 p-3.5 rounded-xl flex items-center justify-between text-left">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="h-8 w-8 rounded-lg bg-brand-purple text-brand-primary flex items-center justify-center hover:bg-brand-purple/90 transition-all shrink-0"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between font-sans text-xs text-brand-bg-primary/75 space-y-4 sm:space-y-0">
          ...
          <div className="flex items-center space-x-1.5">
            ...
            <Heart className="h-3.5 w-3.5 text-brand-purple fill-brand-purple animate-pulse" />

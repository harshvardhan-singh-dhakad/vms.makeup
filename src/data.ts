...
export const SERVICES_DATA: ServiceCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: "hs-1", name: "Hair Cut", category: "Hair Styling", description: "Precision layering, chic bobs, or split-end cleanup with relaxing hair wash.", price: "Price on request" },
      { id: "hs-2", name: "Ironing", category: "Hair Styling", description: "Ultra-sleek, glossy straight hair setting using high-end safe heat protectors.", price: "Price on request" },
      { id: "hs-3", name: "Global Colouring", category: "Hair Styling", description: "Full coverage premium ammonia-free hair color matching your undertone.", price: "Price on request", isPremium: true },
      { id: "hs-4", name: "Blow Dry", category: "Hair Styling", description: "Bouncy, red-carpet-ready volume and shine with professional styling tools.", price: "Price on request" },
      { id: "hs-5", name: "Root Touch Up", category: "Hair Styling", description: "Quick, flawless root coverage matching your existing hair shade.", price: "Price on request" },
      { id: "hs-6", name: "Shampoo & Conditioning", category: "Hair Styling", description: "Gentle cleanse and deep nourishment using luxury salon hair care lines.", price: "Price on request" },
      { id: "hs-7", name: "Head Massage", category: "Hair Styling", description: "Stress-relieving pressure-point massage with organic warm oils to promote circulation.", price: "Price on request" },
      { id: "hs-8", name: "Roller Setting", category: "Hair Styling", description: "Classic retro curls and voluminous waves that last all evening.", price: "Price on request" },
      { id: "hs-9", name: "Oiling", category: "Hair Styling", description: "Traditional deep oiling and scalp treatment for strengthening hair follicles.", price: "Price on request" }
    ]
  },
  {
    id: "hair-texture",
    ...
    items: [
      { id: "ht-1", name: "Keratin Treatment", category: "Hair Texture", description: "Rebuilds damaged protein structures, removing 90% frizz and adding brilliant shine.", price: "Price on request", isPremium: true },
      { id: "ht-2", name: "Smoothening", category: "Hair Texture", description: "Achieve silk-smooth, manageable hair with natural fall and incredible softness.", price: "Price on request", isPremium: true },
      { id: "ht-3", name: "Rebonding", category: "Hair Texture", description: "Permanent hair straightening treatment for perfectly straight and glossy locks.", price: "Price on request", isPremium: true },
      { id: "ht-4", name: "Custom Service Slot (Client to Fill)", category: "Hair Texture", description: "Reserved slot for customizable hair texture treatment (e.g., Cysteine, Botox treatment).", price: "Price on request" }
    ]
  },
  {
    id: "hair-treatments",
    ...
    items: [
      { id: "hm-1", name: "Spa Treatments", category: "Hair Treatments", description: "Deep conditioning steam spa tailored for oily, dry, or dandruff-prone scalps.", price: "Price on request" },
      { id: "hm-2", name: "Advanced Hair Moisturising", category: "Hair Treatments", description: "Intense moisture infusion therapy for dry, chemically treated, or brittle hair.", price: "Price on request", isPremium: true },
      { id: "hm-3", name: "Scalp Treatments", category: "Hair Treatments", description: "Clinical clarifying therapy to fight dandruff, scalp itchiness, and seasonal hair fall.", price: "Price on request" },
      { id: "hm-4", name: "Custom Service Slot (Client to Fill)", category: "Hair Treatments", description: "Reserved slot for advanced clinical hair scalp treatment (e.g., peptide infusion, plex repair).", price: "Price on request" }
    ]
  },
  {
    id: "facials",
    ...
    items: [
      { id: "fr-1", name: "Luxury Facials/Rituals", category: "Facials & Rituals", description: "Premium, multi-step facial utilizing imported botanical serums and anti-aging gold therapies.", price: "Price on request", isPremium: true },
      { id: "fr-2", name: "Clean Ups", category: "Facials & Rituals", description: "Exfoliating and hydrating cleanup targeting blackheads, excess oil, and city pollution.", price: "Price on request" },
      { id: "fr-3", name: "Body Polishing", category: "Facials & Rituals", description: "Full body exfoliation, gentle cream massage, and skin brightener pack for ultimate glow.", price: "Price on request", isPremium: true },
      { id: "fr-4", name: "Bleach", category: "Facials & Rituals", description: "Instantly brightens skin complexion and lightens fine facial hair with cooling care.", price: "Price on request" },
      { id: "fr-5", name: "Threading", category: "Facials & Rituals", description: "Precision eyebrow shaping, forehead, upper-lip, or full face threading.", price: "Price on request" }
    ]
  },
  {
    id: "hand-feet",
    ...
    items: [
      { id: "hf-1", name: "Spa Manicure", category: "Hand & Feet", description: "Luxury hands scrub, deep mask, massage, cuticle care, and gorgeous nail grooming.", price: "Price on request" },
      { id: "hf-2", name: "Spa Pedicure", category: "Hand & Feet", description: "Relaxing foot soak, scrub, organic cream massage, nail shaping, and deep hydration.", price: "Price on request", isPremium: true },
      { id: "hf-3", name: "Manicure", category: "Hand & Feet", description: "Classic nail trimming, shaping, filing, cuticle cleanup, and nourishing massage.", price: "Price on request" },
      { id: "hf-4", name: "Pedicure", category: "Hand & Feet", description: "Refreshing foot cleaning, heel scrubbing, and classic nail grooming.", price: "Price on request" },
      { id: "hf-5", name: "Waxing", category: "Hand & Feet", description: "Smooth waxing using premium honey or chocolate wax for glowing, hair-free skin.", price: "Price on request" }
    ]
  },
  {
    id: "nails",
    ...
    items: [
      { id: "ns-1", name: "Gel Extension", category: "Nail Services", description: "Long-lasting premium gel tips with customized length and shaping.", price: "Price on request", isPremium: true },
      { id: "ns-2", name: "Acrylic Extension", category: "Nail Services", description: "High-strength acrylic nail sculpts for an ultra-glamorous, sturdy look.", price: "Price on request", isPremium: true },
      { id: "ns-3", name: "Gel Overlay", category: "Nail Services", description: "Reinforce and shine your natural nails with a protective, clear gel layer.", price: "Price on request" },
      { id: "ns-4", name: "Gel Paint", category: "Nail Services", description: "Flawless, glossy, chip-resistant gel polish cured under UV light.", price: "Price on request" },
      { id: "ns-5", name: "Chrome", category: "Nail Services", description: "Metallic mirror-like reflective finish applied over your favorite base gel color.", price: "Price on request" },
      { id: "ns-6", name: "Ombre", category: "Nail Services", description: "Beautiful, smooth dual-tone gradient transition from light to dark.", price: "Price on request" },
      { id: "ns-7", name: "Reflecting Glitter", category: "Nail Services", description: "Dazzling micro-glitter coat that sparkles brilliantly under direct light.", price: "Price on request" },
      { id: "ns-8", name: "Cat Eye | 9D", category: "Nail Services", description: "Mystical, holographic magnetic gel look mimicking precious gemstones.", price: "Price on request", isPremium: true },
      { id: "ns-9", name: "Millers Work", category: "Nail Services", description: "Intricate modern nail embellishment including micro-beads and precision studs.", price: "Price on request" },
      { id: "ns-10", name: "French Tips / French Base (Nude)", category: "Nail Services", description: "Classic white tips or subtle elegant nude base for a clean, timeless look.", price: "Price on request" },
      { id: "ns-11", name: "Refilling & Refitting", category: "Nail Services", description: "In-fill gel/acrylic maintenance to extend the life of your extensions.", price: "Price on request" },
      { id: "ns-12", name: "Removal", category: "Nail Services", description: "Safe, chemical-free nail extension removal ensuring zero damage to natural nails.", price: "Price on request" }
    ]
  }
];
